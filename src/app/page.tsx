          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <code className="text-green-400 text-xs break-all">
                {process.env.NEXT_PUBLIC_ML_API_URL || process.env.ML_API_URL || "http://localhost:5000 (default)"}
              </code>
            </div>
            <div className="bg-gray-800 rounded-lg p-4">
              <p className="text-gray-400 mb-1">Local Flask Service</p>
              <code className="text-blue-400 text-xs">{process.env.NEXT_PUBLIC_ML_API_URL || process.env.ML_API_URL || "http://localhost:5000"}</code>
            </div>
          </div>
        </div>
      </div>
